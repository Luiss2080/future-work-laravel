...
@section('description', 'Conoce más sobre la profesión de Ingeniería Civil: Proyectos de infraestructura y construcción')
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <h1 class="page-title display-4 fw-bold mb-3">Ingeniería Civil</h1>
                <p class="page-subtitle lead text-muted mb-4">Proyectos de infraestructura y construcción</p>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Ingeniería Civil</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="col-lg-8">
                <div class="profession-content">
                    <div class="section-block mb-5">
                        <h2 class="mb-4">¿Qué hace un ingeniero civil?</h2>
                        <p class="lead mb-4">Los ingenieros civiles planifican, diseñan y supervisan proyectos de infraestructura, desde edificios hasta carreteras, puentes y sistemas de agua.</p>
                        
                        <h3 class="mt-5 mb-3">Responsabilidades Principales</h3>
                        <ul class="custom-list list-unstyled">
                            <li class="mb-2"><i class="fas fa-check-circle text-primary me-2"></i>Diseño de estructuras y sistemas de construcción</li>
                            <li class="mb-2"><i class="fas fa-check-circle text-primary me-2"></i>Análisis de suelos y materiales de construcción</li>
                            <li class="mb-2"><i class="fas fa-check-circle text-primary me-2"></i>Supervisión y dirección de proyectos</li>
                            <li class="mb-2"><i class="fas fa-check-circle text-primary me-2"></i>Evaluación de impacto ambiental</li>
                            <li class="mb-2"><i class="fas fa-check-circle text-primary me-2"></i>Gestión de presupuestos y recursos</li>
                        </ul>
                    </div>
                ...
                <div class="profession-sidebar sticky-top" style="top: 2rem;">
                    ...
                    <div class="sidebar-card card border-0 shadow-sm bg-primary text-white">
                        <div class="card-body text-center">
                            ...
                            <p class="card-text mb-4 opacity-75">Explora las oportunidades disponibles en Ingeniería Civil</p>
