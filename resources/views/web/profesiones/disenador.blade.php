...
@section('description', 'Conoce más sobre la profesión de Diseño de Interiores: Decoración y ambientación de espacios')
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="profession-icon mb-4">
                    <i class="fas fa-paint-brush text-primary" style="font-size: 4rem;"></i>
                </div>
                <h1 class="page-title display-4 fw-bold mb-3">Diseño de Interiores</h1>
                <p class="page-subtitle lead text-muted mb-4">Decoración y ambientación de espacios</p>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Diseño de Interiores</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="col-lg-8">
                <div class="profession-content">
                    <div class="section-block mb-5">
                        <h2 class="mb-4">¿Qué hace un diseñador de interiores?</h2>
                        <p class="lead mb-4">Los diseñadores de interiores transforman espacios creando ambientes funcionales, estéticos y personalizados para sus clientes.</p>
                        
                        <h3 class="mt-5 mb-3">Responsabilidades Principales</h3>
                        <ul class="custom-list list-unstyled">
                            <li class="mb-2"><i class="fas fa-check-circle text-primary me-2"></i>Desarrollo de conceptos y propuestas de diseño</li>
                            <li class="mb-2"><i class="fas fa-check-circle text-primary me-2"></i>Selección de materiales, colores y mobiliario</li>
                            <li class="mb-2"><i class="fas fa-check-circle text-primary me-2"></i>Elaboración de planos y renders 3D</li>
                            <li class="mb-2"><i class="fas fa-check-circle text-primary me-2"></i>Coordinación con proveedores y contratistas</li>
                            <li class="mb-2"><i class="fas fa-check-circle text-primary me-2"></i>Supervisión de la implementación del diseño</li>
                        </ul>
                    </div>
                ...
                <div class="profession-sidebar sticky-top" style="top: 2rem;">
                    ...
                    <div class="sidebar-card card border-0 shadow-sm bg-primary text-white">
                        <div class="card-body text-center">
                            ...
                            <p class="card-text mb-4 opacity-75">Explora las oportunidades disponibles en Diseño de Interiores</p>
